        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "type",
                    models.CharField(
                        choices=[("power", "Power"), ("cooling", "Cooling"), ("network", "Network")],
                        db_index=True,
                        max_length=20,
                    ),
                ),
                ...
                (
                    "location",
                    models.CharField(blank=True, help_text="Physical location description", max_length=255, null=True),
                ),
                (
                    "power_capacity",
                    models.IntegerField(
            ...
            options={
                ...
                "indexes": [
                    models.Index(fields=["site"], name="providers_site_id_92efe6_idx"),
                    models.Index(fields=["type"], name="providers_type_48a9d0_idx"),
                    models.Index(fields=["rack"], name="providers_rack_id_f7cb89_idx"),
                ],
            },
        ),
    ]
